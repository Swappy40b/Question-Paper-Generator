...
<?php 
$querymcq ="SELECT * FROM mcq_quetion WHERE sid=".$_GET['sid']." ORDER BY RAND() LIMIT 6";
...
<div id="any_two">
<br><h3>B) Attempt any one of the following.[4]</h3>
<?php 
$querytwo ="SELECT * FROM theory_quetion WHERE sid=".$_GET['sid']." AND catid=3 ORDER BY RAND() LIMIT 2";
...
<div id="any_four">
<br><h3>C) Attempt any two of the following.[10]</h3>
<?php 
$querynote ="SELECT * FROM theory_quetion WHERE sid=".$_GET['sid']." AND catid=5 ORDER BY RAND() LIMIT 3";
