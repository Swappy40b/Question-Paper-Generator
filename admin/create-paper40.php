...
<?php 
$querymcq ="SELECT * FROM mcq_quetion WHERE sid=".$_GET['sid']." ORDER BY RAND() LIMIT 8";
...
<div id="any_two">
<br><h3>B) Attempt any two of the following.[16]</h3>
<?php 
$querytwo ="SELECT * FROM theory_quetion WHERE sid=".$_GET['sid']." AND catid=3 ORDER BY RAND() LIMIT 3";
...
<div id="any_four">
<br><h3>C) Write a short note on following [16]</h3>
<?php 
